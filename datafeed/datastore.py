...
class RockStore(object):
    ...
    Rockstore keys are prefixed[1] with 3-bytes, the first two bytes are
    manually fixed((eg: 0x0001) which is using to identify different data types,
    the max data types are 2**16 - 1 or equally 65535 which should be sufficient.
